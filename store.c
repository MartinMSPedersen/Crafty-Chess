...
********************************************************************************
*/
void StoreBest(TREE *tree, int ply, int depth, int wtm, int value,
               int alpha, int threat) {
...
********************************************************************************
*/
void StoreRefutation(TREE *tree, int ply, int depth, int wtm,
                     int bound, int threat) {
  register HASH_ENTRY *htablea, *htableb;
  register BITBOARD word1, word2;
  register int draft, age;
/*
