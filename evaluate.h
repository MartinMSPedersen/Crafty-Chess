...
#  define   KING_SAFETY_RP_FILE_OTHERHALF_OPEN           (2)
 
#  define                  KING_SAFETY_NP_ADV1           (2)
#  define               KING_SAFETY_NP_TOO_FAR           (3)
#  define        KING_SAFETY_NP_FILE_HALF_OPEN           (4)
#  define   KING_SAFETY_NP_FILE_OTHERHALF_OPEN           (2)
 
#  define                  KING_SAFETY_BP_ADV1           (0)
#  define               KING_SAFETY_BP_TOO_FAR           (0)
#  define        KING_SAFETY_BP_FILE_HALF_OPEN           (1)
#  define   KING_SAFETY_BP_FILE_OTHERHALF_OPEN           (1)
